        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <motion.h1 variants={itemAnimation} className="text-4xl lg:text-left">Bruno🍊</motion.h1>
                        <motion.h1 variants={itemAnimation} className="text-2xl text-brunoColor-950 text-opacity-80">Edad: 1 año 10 meses</motion.h1>
                    </motion.dl>
                    <motion.p variants={itemAnimation} className="text-brunoColor-900 text-opacity-80 lg:text-left">Gato Naranja</motion.p>
                    <motion.p variants={itemAnimation} className="text-brunoColor-900 text-sm text-opacity-60 pb-5 px-10 lg:px-0 lg:pb-0 lg:text-left">
