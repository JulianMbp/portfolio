        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <motion.h1 variants={itemAnimation} className="text-4xl lg:text-left">Brownie🍫</motion.h1>
                        <motion.h1 variants={itemAnimation} className="text-2xl text-slate-50 text-opacity-80">Edad: 3 años</motion.h1>
                    </motion.dl>
                    <motion.p variants={itemAnimation} className="text-brownieColor-100 text-opacity-80">Mestiza</motion.p>
                    <motion.p variants={itemAnimation} className="text-brownieColor-100 text-sm text-opacity-60 pb-5 px-10 lg:px-0 lg:pb-0 lg:text-left">
