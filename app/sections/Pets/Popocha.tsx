        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <motion.h1 variants={itemAnimation} className="text-4xl lg:text-left">Popocha🐾</motion.h1>
                    ...
                    <motion.p variants={itemAnimation} className="text-slate-50 text-sm text-opacity-60 pb-5 px-10 lg:px-0 lg:pb-0 lg:text-left">
