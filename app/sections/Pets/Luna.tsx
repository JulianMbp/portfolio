        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <motion.h1 variants={itemAnimation} className="text-4xl lg:text-left">Luna🌙</motion.h1>
                        <motion.h1 variants={itemAnimation} className="text-2xl text-brunoColor-950 text-opacity-80">Edad: 16 años</motion.h1>
                    </motion.dl>
                    <motion.p variants={itemAnimation} className="text-lunaColor-950 text-opacity-80">Cruce de West highland White terrier con Puddle</motion.p>
                    <motion.p variants={itemAnimation} className="text-lunaColor-900 text-sm text-opacity-60 pb-5 px-10 lg:px-0 lg:pb-0 lg:text-left">
