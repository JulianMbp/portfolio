...
const aboutMe = () => {
    return (
        <div className=" dark:border-slate-100 dark:border-opacity-45 border-opacity-45  border-slate-900">
            {/* About Me */}
        <section className="container  grid grid-cols-1 md:grid-cols-2" id='about'>
            ...
            <div className="md:pt-56 order-2 md:order-2 p-5 object-center md:row-span-2 md:rounded-lg rounded-full item-center justify-center  ">
