...
const Music = () => {
    ...
    return (
        ...
        >
            <motion.h1 variants={itemAnimation} className="font-extralight font-serif text-8xl md:text-9xl order-1 text-slate-50 text-center md:text-left mb-16">
                My Music
            </motion.h1>

            <motion.svg variants={noteAnimation} className="hidden lg:block h-64 w-64 md:-ml-[1250px] md:-mb-[100px] text-slate-100" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M9 18V5l12-2v13" />
                <circle cx="6" cy="18" r="3" />
                <circle cx="18" cy="16" r="3" />
            </motion.svg>

            <motion.svg variants={noteAnimation} className="h-64 w-64 text-slate-100 hidden md:block md:-mr-[1250px] md:-mb-[500px]" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            <motion.dl variants={itemAnimation} className="order-2 border border-slate-50  w-[300px] md:w-[60%] rounded-lg flex flex-col justify-between gap-2 shadow-2xl">
                ...
                <motion.section variants={itemAnimation} className="order-4 justify-evenly flex mb-10">
                    <motion.button whileHover="hover" whileTap="tap" variants={buttonAnimation}>
                        <svg className="h-10 w-10 text-slate-100" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
