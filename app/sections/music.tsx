...
const music = () => {
    return (
        <section id="music" className=" text-center md:w-[90%] items-center justify-center mb-10 flex flex-col mt-40">
            <h1 className="font-extralight font-serif text-8xl md:text-9xl order-1 dark:text-slate-50 text-center md:text-left mb-16">My Music</h1>
            <svg className="hidden lg:block animate-bounce h-64 w-64 md:-ml-[1250px] md:-mb-[100px] dark:text-slate-100 "  width="24"  height="24"  viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <path d="M9 18V5l12-2v13" />  <circle cx="6" cy="18" r="3" />  <circle cx="18" cy="16" r="3" /></svg>
            <svg className="h-64 w-64 dark:text-slate-100 hidden md:block animate-bounce md:-mr-[1250px] md:-mb-[500px] "  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="6" cy="17" r="3" />  <circle cx="16" cy="17" r="3" />  <polyline points="9 17 9 4 19 4 19 17" />  <line x1="9" y1="8" x2="19" y2="8" /></svg>

            <dl className="order-2 border  dark:border-slate-50 border-slate-950 w-[300px] md:w-[60%] rounded-lg  flex flex-col justify-between gap-2 shadow-2xl">
                {/* Imagen de portada */}
                ...
                <section className="order-3 px-[5%] mb-10">
                    <dl className="mt-6 dark:bg-slate-200  bg-slate-950 bg-opacity-50 h-2 rounded-full ">
                        <dl className="dark:bg-slate-50 bg-slate-950 h-2 rounded-full w-1/2">
                        </dl>
                    </dl>
                ...
                <section className="order-4 justify-evenly flex mb-10">
                    <button >
                        <svg className="h-10 w-10 dark:text-slate-100 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <polygon points="19 20 9 12 19 4 19 20" />  <line x1="5" y1="19" x2="5" y2="5" /></svg>
                    </button>
                    <button >
                        <svg className="h-10 w-10 dark:text-slate-100 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <polygon points="5 3 19 12 5 21 5 3" /></svg>
                    </button>
                    <button>
