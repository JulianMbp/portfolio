    ...
    return(
      ...
      <ModalExp isOpen={isModalOpen} onClose={closeModal}  title="Ciclista Profesional">
        ...
        <dl>        
          ...
          <p className="text-zinc-950 dark:text-zinc-50 text-left"> 1ro Clasica Nuestra señora de los milagros </p>
          <p className="text-zinc-950 dark:text-zinc-50 text-left opacity-70 -mt-1">Guatarilla - Nariño </p>
          <p className="text-cyan-600 text-left opacity-70 -mt-1">2019</p>
          
          <p className="text-zinc-950 dark:text-zinc-50 text-left mt-3">1ro Campeonato de Escuelas de Ciclismo</p>
          <p className="text-zinc-950 dark:text-zinc-50 text-left opacity-70 -mt-1"> Nariño </p>
          <p className="text-cyan-600 text-left opacity-70 -mt-1">2019</p>

          <p className="text-zinc-950 dark:text-zinc-50 text-left mt-3">1ro Clasica Nuestra señora de los milagros </p>
          <p className="text-zinc-950 dark:text-zinc-50 text-left opacity-70 -mt-1">Gualmatan Nariño</p>
          <p className="text-cyan-600 text-left opacity-70 -mt-1">2020</p>
          
          <p className="text-zinc-950 dark:text-zinc-50 text-left mt-3">1ro Contrareloj Chequeos Campeonatos Nacionales</p>
          <p className="text-zinc-950 dark:text-zinc-50 text-left opacity-70 -mt-1">Nariño </p>
          <p className="text-cyan-600 text-left opacity-70 -mt-1">2021 </p>

          <p className="text-zinc-950 dark:text-zinc-50 text-left mt-3 ">5to Etapa 5 Vuelta del Porvenir</p>
          <p className="text-zinc-950 dark:text-zinc-50 text-left opacity-70 -mt-1">Nariño </p>
          <p className="text-cyan-600 text-left opacity-70 -mt-1">2021 </p>
