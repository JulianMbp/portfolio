...
const ButtonPage: React.FC = () => {
    ...
    return(
      <section>
        <button
        className='h-16 duration-300 flex items-center rounded-3xl p-3 bg-blue-500 gap-3 
        ...
        onClick={openModal}>
                <svg className=" h-8 w-8 dark:text-slate-100"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Software Engineer" >
        <p className="font-semibold text-lg text-cyan-400">Numero de Contacto</p>
        <p className="text-zinc-950 dark:text-zinc-50">315-242-74-21</p>
        <p className="font-semibold  text-lg text-cyan-400">Correo Electronico</p>
        <dl className="flex items-center justify-between">
          <p className="text-zinc-950 dark:text-zinc-50">julian.bastidasmp@gmail.com</p>
