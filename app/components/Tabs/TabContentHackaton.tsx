    ...
    return (
        <section className="bg-violet-600 h-[100%] w-[100%] rounded-lg ">
            ...
            <dl className="p-10 order-1 lg:w-[70%] text-center lg:text-left flex flex-col justify-center text-slate-50 font-serif pl-10">
                ...
                <p className=" text-slate-50 text-opacity-80">Desarrolle el Frontend de la aplicacion mobile<br />
                        Para despues juntarla con el backend del grupo que me tocó<br />
                        <br />
                        Utilidad de la aplicacion: <br />
                        Registro y Login: Autenticación para usuarios de la empresa. <br />
                        ...
                        Administración de Empleados: Asociación de empleados a proyectos específicos.</p>
                <dl className="grid grid-cols-4 gap-3 mt-5">
                    ...
                    <FaNodeJs className="order-7 h-16 w-16 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200" />
                    ...
                    <RiTailwindCssFill className="order-3 h-16 w-16 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200" />
                </dl>
