    ...
    return (
        <section className="bg-blue-500 h-[100%] w-[100%] rounded-lg ">
            ...
            <dl className=" order-1 lg:w-[70%] text-center lg:text-left grid grid-cols-1 justify-center text-brownieColor-100 font-serif p-10">
                ...
                <p className=" text-brownieColor-100 text-opacity-80 w-[100%] 
                text-center items-center md:w-[100%] md:text-left pt-5 md:pl-0 ">
                    - Desarrollar un aplicativo web PHP, JavaScript, Bootstrap, HTML,
                    y MySQL para certificar estudiantes con generación de PDF, seguridad 
                    y autenticación en institución educativa. </p>           
                    <p className="text-brownieColor-100 text-opacity-80 w-[100%] 
                text-center items-center md:w-[100%] md:text-left pt-5 md:pl-0 hidden md:block">- Diseñar Base de datos.	<br />
                ...
                <dl className="grid grid-cols-3 gap-3 mt-5 ">
                    <FaBootstrap className="order-4 h-10 w-10 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200" />
                    <TiHtml5 className="order-3 h-10 w-10 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200" />
                    ...
                    <FaPhp className="order-1 h-10 w-10 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200" />
                    <SiMysql className="col-start-3 order-5 h-10 w-10 hover:duration-500  hover:scale-125 hover:shadow-2xl transition-all active:scale-95 active:duration-200" />
                </dl>
